...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleAccessDenied(AccessDeniedException ex) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(ApiResponse.error("Anda tidak memiliki hak akses untuk tindakan ini."));
    }
    ...
    public ResponseEntity<ApiResponse<Object>> handleAiProcessing(AiProcessingException ex) {
        ...
        return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE)
                .body(ApiResponse.error("Layanan AI sedang sibuk atau mengalami kendala: " + ex.getMessage()));
    }
